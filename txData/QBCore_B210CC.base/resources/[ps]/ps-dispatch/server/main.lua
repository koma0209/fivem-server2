...
lib.addCommand('411', {
    help = 'Send a message to 411',
    params = { { name = 'message', type = 'string', help = '411 Message' }},
}, function(source, args, raw)
    local fullMessage = raw:sub(5)
    TriggerClientEvent('ps-dispatch:client:sendEmergencyMsg', source, fullMessage, "411", false)
end)

lib.addCommand('411a', {
    help = 'Send an anonymous message to 411',
    params = { { name = 'message', type = 'string', help = '411 Message' }},
}, function(source, args, raw)
    local fullMessage = raw:sub(5)
    TriggerClientEvent('ps-dispatch:client:sendEmergencyMsg', source, fullMessage, "411", true)
end)
