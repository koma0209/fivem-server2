...
AddEventHandler('gameEventTriggered', function(name, args)
    ...
    WaitTimer('PlayerDowned', function()
        ...
        elseif PlayerData.job.type == 'ems' then
            ...
            if PlayerData.job.type == 'bcso'  then
                exports['ps-dispatch']:OfficerDown()
            end    
            --自動死亡通知Off
            --exports['ps-dispatch']:AmbulanceInjuriedPerson()
            --exports['ps-dispatch']:PDoctorInjuriedPerson()
            --exports['ps-dispatch']:POLICEInjuriedPerson()
        end
    end)
end)
